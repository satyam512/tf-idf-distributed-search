...
/**
 * (responseBody -> (Result)SerializationUtils.deserialize(responseBody))
 * lambda equivalent of :
 *
 * Result someFunc(byte [] responseBody){
 *     return (Result) SerializationUtils.deserialize(responseBody);
 * }
 *
 */
